...
app.post('/api/employees', async (req, res) => {
    try {
        const { designation_id, employee_name, job_title, salary, employee_image, email, phone_number, home_address } = req.body;
        const result = await pool.query('INSERT INTO employees (designation_id, employee_name, job_title, salary, employee_image, email, phone_number, home_address) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) returning employee_id;', [designation_id, employee_name, job_title, salary, employee_image, email, phone_number, home_address])
